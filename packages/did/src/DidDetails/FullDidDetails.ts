...
const methodMapping: Record<string, VerificationKeyRelationship | undefined> = {
  ...
  'chainSpaceDid.removeDelegate': 'capabilityDelegation',
  'chainSpaceDid.create': 'authentication',
  'chainSpaceDid.archive': 'authentication',
  'chainSpaceDid.restore': 'authentication',
  'chainSpaceDid.subspaceCreate': 'authentication',
  'chainSpaceDid.updateTransactionCapacitySub': 'authentication',
  did: 'authentication',
