 ...
 */
export function decodeDocumentStatementDetailsfromChain(
 ...
 * @param statement
 */
export async function getDocumentStatementDetailsfromChain(
  ...
  const decodedDetails = decodeDocumentStatementDetailsfromChain(
    statementEntry,
    statementId
  )
 ...
 * @param digest
 */
export async function getDocumentStatementStatusfromChain(
  statement: StatementId,
  ...
  const statementDetails = await getDocumentStatementDetailsfromChain(
    statementId
  )
