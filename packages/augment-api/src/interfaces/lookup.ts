...
export default {
  ...
  /**
   * Lookup245: pallet_network_score::types::RatingInputEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32, pallet_network_score::types::EntityTypeOf, pallet_network_score::types::RatingTypeOf>
   **/
  ...
  /**
   * Lookup246: pallet_network_score::types::EntityTypeOf
   **/
  PalletNetworkScoreEntityTypeOf: {
    _enum: ['Retail', 'Logistic']
  },
  /**
   * Lookup247: pallet_network_score::types::RatingTypeOf
   **/
  PalletNetworkScoreRatingTypeOf: {
    _enum: ['Overall', 'Delivery']
  },
  /**
   * Lookup248: pallet_asset::pallet::Call<T>
   **/
  PalletAssetCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup249: pallet_asset::types::AssetInputEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, pallet_asset::types::AssetTypeOf, bounded_collections::bounded_vec::BoundedVec<T, S>, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup251: pallet_asset::types::AssetTypeOf
   **/
  PalletAssetAssetTypeOf: {
    _enum: ['ART', 'BOND', 'MF']
  },
  /**
   * Lookup252: pallet_asset::types::AssetIssuanceEntry<cord_identifier::curi::Ss58Identifier, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup254: pallet_asset::types::AssetTransferEntry<cord_identifier::curi::Ss58Identifier, cord_identifier::curi::Ss58Identifier, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup256: sp_runtime::traits::BlakeTwo256
   **/
  SpRuntimeBlakeTwo256: 'Null',
  /**
   * Lookup258: pallet_scheduler::RetryConfig<Period>
   **/
  ...
  /**
   * Lookup406: pallet_asset::pallet::Error<T>
   **/
  PalletAssetError: {
  ...
  /**
   * Lookup410: pallet_network_membership::CheckNetworkMembership<T>
   **/
  ...
  /**
   * Lookup419: cord_runtime::Runtime
   **/
