...
export default {
  ...
  /**
   * Lookup77: pallet_scoring::pallet::Event<T>
   **/
  PalletScoringEvent: {
    _enum: {
      JournalEntry: {
  ...
  /**
   * Lookup78: pallet_sudo::pallet::Event<T>
   **/
  PalletSudoEvent: {
    _enum: {
      Sudid: {
  ...
  /**
   * Lookup106: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<cord_runtime::RuntimeCall>, BlockNumber, cord_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup107: frame_support::traits::preimages::Bounded<cord_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup109: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup111: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup112: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup113: sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup114: sp_runtime::traits::BlakeTwo256
   **/
  ...
  /**
   * Lookup117: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup122: pallet_indices::pallet::Call<T>
   **/
  PalletIndicesCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup128: cord_authority_membership::pallet::Call<T>
   **/
  ...
  /**
   * Lookup129: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup130: cord_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup131: sp_authority_discovery::app::Public
   **/
  ...
  /**
   * Lookup133: sp_consensus_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup134: sp_consensus_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup135: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup137: sp_consensus_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup141: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup144: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup145: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup146: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup235: pallet_did_names::pallet::Call<T>
   **/
  PalletDidNamesCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup237: pallet_scoring::pallet::Call<T>
   **/
  PalletScoringCall: {
    _enum: {
      add_rating: {
  ...
  /**
   * Lookup238: pallet_scoring::types::RatingInput<pallet_scoring::types::RatingEntryDetails<sp_core::crypto::AccountId32, bounded_collections::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32, pallet_scoring::types::RatingTypeOf, RatingOf, pallet_scoring::types::RatingEntryType, CountOf>, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup239: pallet_scoring::types::RatingEntryDetails<sp_core::crypto::AccountId32, bounded_collections::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32, pallet_scoring::types::RatingTypeOf, RatingOf, pallet_scoring::types::RatingEntryType, CountOf>
   **/
  ...
  /**
   * Lookup241: pallet_scoring::types::RatingTypeOf
   **/
  PalletScoringRatingTypeOf: {
    _enum: ['Overall', 'Delivery']
  },
  /**
   * Lookup242: pallet_scoring::types::RatingEntryType
   **/
  ...
  /**
   * Lookup273: pallet_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup275: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
    _enum: ['VestingBalance', 'LiquidityRestrictions', 'InsufficientBalance', 'ExistentialDeposit', 'Expendability', 'ExistingVestingSchedule', 'DeadAccount', 'TooManyReserves', 'TooManyHolds', 'TooManyFreezes']
  },
  /**
   * Lookup276: cord_authority_membership::pallet::Error<T>
   **/
  ...
  /**
   * Lookup277: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup285: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup286: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup289: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup293: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup298: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
    _enum: ['InvalidKey', 'DuplicatedHeartbeat']
  },
  /**
   * Lookup301: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup308: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup309: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup311: pallet_membership::pallet::Error<T, I>
   **/
  PalletMembershipError: {
    _enum: ['AlreadyMember', 'NotMember', 'TooManyMembers']
  },
  /**
   * Lookup314: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup316: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup319: pallet_remark::pallet::Error<T>
   **/
  PalletRemarkError: {
    _enum: ['Empty', 'BadContext']
  },
  /**
   * Lookup320: pallet_identity::types::Registration<sp_core::crypto::AccountId32, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup325: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup326: network_membership::MemberData<BlockNumber>
   **/
  NetworkMembershipMemberData: {
    expireOn: 'u32'
  },
  /**
   * Lookup328: pallet_network_membership::pallet::Error<T>
   **/
  ...
  /**
   * Lookup329: pallet_did::did_details::DidDetails<T>
   **/
  PalletDidDidDetails: {
  ...
  /**
   * Lookup334: pallet_did::did_details::DidPublicKeyDetails<BlockNumber, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup335: pallet_did::did_details::DidPublicKey<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup340: pallet_did::pallet::Error<T>
   **/
  PalletDidError: {
  ...
  /**
   * Lookup341: pallet_schema::types::SchemaEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, primitive_types::H256, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup342: pallet_schema::pallet::Error<T>
   **/
  PalletSchemaError: {
  ...
  /**
   * Lookup343: pallet_registry::types::RegistryEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, primitive_types::H256, cord_primitives::curi::Ss58Identifier, sp_core::crypto::AccountId32, StatusOf>
   **/
  ...
  /**
   * Lookup344: pallet_registry::types::RegistryAuthorization<cord_primitives::curi::Ss58Identifier, sp_core::crypto::AccountId32, cord_primitives::curi::Ss58Identifier, pallet_registry::types::Permissions>
   **/
  ...
  /**
   * Lookup345: pallet_registry::types::Permissions
   **/
  PalletRegistryPermissions: {
    bits: 'u32'
  },
  /**
   * Lookup348: pallet_registry::types::RegistryCommit<pallet_registry::types::RegistryCommitActionOf, primitive_types::H256, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup352: pallet_stream::types::StreamEntry<primitive_types::H256, sp_core::crypto::AccountId32, cord_primitives::curi::Ss58Identifier, cord_primitives::curi::Ss58Identifier, StatusOf>
   **/
  ...
  /**
   * Lookup354: pallet_stream::types::StreamCommit<pallet_stream::types::StreamCommitActionOf, primitive_types::H256, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup355: pallet_stream::types::StreamCommitActionOf
   **/
  PalletStreamStreamCommitActionOf: {
    _enum: ['Genesis', 'Update', 'Revoke', 'Restore', 'Remove', 'Digest']
  },
  /**
   * Lookup356: pallet_stream::types::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup358: pallet_stream::pallet::Error<T>
   **/
  PalletStreamError: {
  ...
  /**
   * Lookup359: pallet_did_names::did_name::DidNameOwnership<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup360: pallet_did_names::pallet::Error<T>
   **/
  PalletDidNamesError: {
  ...
  /**
   * Lookup361: pallet_unique::types::UniqueEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32, Option<cord_primitives::curi::Ss58Identifier>, StatusOf>
   **/
  ...
  /**
   * Lookup364: pallet_unique::types::UniqueCommit<pallet_unique::types::UniqueCommitActionOf, bounded_collections::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup365: pallet_unique::types::UniqueCommitActionOf
   **/
  PalletUniqueUniqueCommitActionOf: {
    _enum: ['Genesis', 'Update', 'Revoke', 'Restore', 'Remove']
  },
  /**
   * Lookup366: pallet_unique::types::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup368: pallet_unique::pallet::Error<T>
   **/
  PalletUniqueError: {
  ...
  /**
   * Lookup372: pallet_scoring::types::ScoreEntry<CountOf, RatingOf>
   **/
  ...
  /**
   * Lookup374: pallet_scoring::pallet::Error<T>
   **/
  PalletScoringError: {
  ...
  /**
   * Lookup375: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  ...
  /**
   * Lookup379: pallet_network_membership::CheckNetworkMembership<T>
   **/
  PalletNetworkMembershipCheckNetworkMembership: 'Null',
  /**
   * Lookup380: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup381: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup382: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup383: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup386: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup387: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup388: cord_runtime::Runtime
   **/
