...
export default {
  ...
  /**
   * Lookup112: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<cord_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, cord_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup113: frame_support::traits::preimages::Bounded<cord_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>
   **/
  ...
  /**
   * Lookup115: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup133: cord_authority_membership::pallet::Call<T>
   **/
  ...
  /**
   * Lookup137: sp_mixnet::types::app::Public
   **/
  ...
  /**
   * Lookup155: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup156: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup159: pallet_node_authorization::pallet::Call<T>
   **/
  ...
  /**
   * Lookup160: pallet_runtime_upgrade::pallet::Call<T>
   **/
  ...
  /**
   * Lookup163: cord_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup165: pallet_collective::RawOrigin<sp_core::crypto::AccountId32, I>
   **/
  ...
  /**
   * Lookup167: pallet_did::origin::DidRawOrigin<sp_core::crypto::AccountId32, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup171: pallet_remark::pallet::Call<T>
   **/
  PalletRemarkCall: {
    _enum: {
      store: {
  ...
  /**
   * Lookup173: pallet_identity::simple::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup206: pallet_identity::types::BitFlags<pallet_identity::simple::IdentityField>
   **/
  ...
  /**
   * Lookup210: pallet_mixnet::Registration<BlockNumber, pallet_mixnet::BoundedMixnode<bounded_collections::bounded_vec::BoundedVec<bounded_collections::bounded_vec::BoundedVec<T, S>, S>>>
   **/
  ...
  /**
   * Lookup211: pallet_mixnet::BoundedMixnode<bounded_collections::bounded_vec::BoundedVec<bounded_collections::bounded_vec::BoundedVec<T, S>, S>>
   **/
  ...
  /**
   * Lookup214: sp_mixnet::types::app::Signature
   **/
  ...
  /**
   * Lookup239: pallet_did::did_details::DidAuthorizedCallOperation<sp_core::crypto::AccountId32, cord_runtime::RuntimeCall, BlockNumber, sp_core::crypto::AccountId32, TxCounter>
   **/
  ...
  /**
   * Lookup243: pallet_statement::pallet::Call<T>
   **/
  PalletStatementCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup250: pallet_asset::pallet::Call<T>
   **/
  PalletAssetCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup251: pallet_asset::types::AssetInputEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, pallet_asset::types::AssetTypeOf, bounded_collections::bounded_vec::BoundedVec<T, S>, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup253: pallet_asset::types::AssetTypeOf
   **/
  PalletAssetAssetTypeOf: {
    _enum: ['ART', 'BOND', 'MF']
  },
  /**
   * Lookup254: pallet_asset::types::AssetIssuanceEntry<cord_identifier::curi::Ss58Identifier, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup256: pallet_asset::types::AssetTransferEntry<cord_identifier::curi::Ss58Identifier, cord_identifier::curi::Ss58Identifier, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup375: pallet_schema::types::SchemaEntry<bounded_collections::bounded_vec::BoundedVec<T, S>, primitive_types::H256, sp_core::crypto::AccountId32, cord_identifier::curi::Ss58Identifier>
   **/
  ...
  /**
   * Lookup378: pallet_chain_space::types::SpaceAuthorization<cord_identifier::curi::Ss58Identifier, sp_core::crypto::AccountId32, pallet_chain_space::types::Permissions>
   **/
  ...
  /**
   * Lookup382: pallet_statement::types::StatementDetails<primitive_types::H256, cord_identifier::curi::Ss58Identifier, cord_identifier::curi::Ss58Identifier>
   **/
  ...
  /**
   * Lookup384: pallet_statement::types::StatementPresentationDetails<sp_core::crypto::AccountId32, pallet_statement::types::PresentationTypeOf, primitive_types::H256, cord_identifier::curi::Ss58Identifier>
   **/
  ...
  /**
   * Lookup401: pallet_asset::pallet::Error<T>
   **/
  PalletAssetError: {
