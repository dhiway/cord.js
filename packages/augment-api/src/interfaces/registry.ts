...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletScoreAggregatedEntryOf: PalletScoreAggregatedEntryOf;
    PalletScoreCall: PalletScoreCall;
    PalletScoreEntityTypeOf: PalletScoreEntityTypeOf;
    PalletScoreEntryTypeOf: PalletScoreEntryTypeOf;
    PalletScoreError: PalletScoreError;
    PalletScoreEvent: PalletScoreEvent;
    PalletScoreRatingEntry: PalletScoreRatingEntry;
    PalletScoreRatingInputEntry: PalletScoreRatingInputEntry;
