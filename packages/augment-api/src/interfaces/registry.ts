...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletWitnessCall: PalletWitnessCall;
    PalletWitnessError: PalletWitnessError;
    PalletWitnessEvent: PalletWitnessEvent;
    PalletWitnessWitnessEntry: PalletWitnessWitnessEntry;
    PalletWitnessWitnessSignersEntry: PalletWitnessWitnessSignersEntry;
    PalletWitnessWitnessStatusOf: PalletWitnessWitnessStatusOf;
