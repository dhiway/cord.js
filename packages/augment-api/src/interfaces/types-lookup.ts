...
declare module '@polkadot/types/lookup' {
  ...
  /** @name CordAuthorityMembershipEvent (34) */
  ...
  /** @name CordRuntimeEntitiesValidatorFullIdentification (52) */
  ...
  /** @name PalletNodeAuthorizationEvent (63) */
  ...
  /** @name PalletNetworkMembershipEvent (67) */
  ...
  /** @name PalletNetworkScoreEvent (79) */
  ...
  /** @name PalletAssetAssetStatusOf (83) */
  ...
  /** @name PalletWitnessEvent (85) */
  interface PalletWitnessEvent extends Enum {
    readonly isCreate: boolean;
    readonly asCreate: {
      readonly identifier: Bytes;
      readonly creator: AccountId32;
    ...
    readonly asWitness: {
      ...
      readonly currentWitnessCount: u32;
      readonly requiredWitnessCount: u32;
      readonly status: PalletWitnessWitnessStatusOf;
      readonly comment: Bytes;
    } & Struct;
    readonly isDocumentWitnessComplete: boolean;
    readonly asDocumentWitnessComplete: {
      readonly identifier: Bytes;
    } & Struct;
    readonly type: 'Create' | 'Witness' | 'DocumentWitnessComplete';
  }

  /** @name PalletWitnessWitnessStatusOf (87) */
  interface PalletWitnessWitnessStatusOf extends Enum {
    readonly isWitnessaprrovalpending: boolean;
    readonly isWitnessapprovalcomplete: boolean;
    readonly type: 'Witnessaprrovalpending' | 'Witnessapprovalcomplete';
  }
  ...
  /** @name FrameSystemCodeUpgradeAuthorization (96) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (102) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassU32 (106) */
  ...
  /** @name SpWeightsRuntimeDbWeight (107) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (118) */
  ...
  /** @name CordAuthorityMembershipCall (127) */
  ...
  /** @name PalletBalancesAdjustmentDirection (134) */
  ...
  /** @name CordRuntimeSessionKeys (136) */
  ...
  /** @name SpConsensusGrandpaEquivocationProof (143) */
  interface SpConsensusGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpConsensusGrandpaEquivocation;
  }

  /** @name SpConsensusGrandpaEquivocation (144) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (145) */
  ...
  /** @name FinalityGrandpaPrevote (146) */
  interface FinalityGrandpaPrevote extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name SpConsensusGrandpaAppSignature (147) */
  ...
  /** @name PalletImOnlineHeartbeat (154) */
  ...
  /** @name PalletImOnlineSr25519AppSr25519Signature (155) */
  interface PalletImOnlineSr25519AppSr25519Signature extends U8aFixed {}

  /** @name PalletIdentityCall (156) */
  ...
  /** @name PalletIdentityLegacyIdentityInfo (157) */
  ...
  /** @name PalletIdentityJudgement (192) */
  ...
  /** @name PalletNodeAuthorizationCall (201) */
  ...
  /** @name PalletRuntimeUpgradeCall (202) */
  ...
  /** @name PalletNetworkMembershipCall (203) */
  ...
  /** @name PalletDidDidDetailsDidCreationDetails (205) */
  ...
  /** @name CordRuntimeMaxNewKeyAgreementKeys (206) */
  type CordRuntimeMaxNewKeyAgreementKeys = Null;

  /** @name PalletDidServiceEndpointsDidEndpoint (207) */
  ...
  /** @name PalletDidDidDetailsDidEncryptionKey (216) */
  ...
  /** @name PalletDidDidDetailsDidVerificationKey (220) */
  ...
  /** @name PalletDidDidDetailsDidSignature (223) */
  ...
  /** @name PalletDidDidDetailsDidAuthorizedCallOperation (224) */
  ...
  /** @name PalletStatementPresentationTypeOf (229) */
  ...
  /** @name PalletNetworkScoreCall (231) */
  ...
  /** @name PalletNetworkScoreRatingInputEntry (232) */
  ...
  /** @name PalletNetworkScoreRatingTypeOf (233) */
  ...
  /** @name PalletAssetAssetInputEntry (235) */
  ...
  /** @name PalletAssetAssetTypeOf (236) */
  ...
  /** @name PalletAssetAssetIssuanceEntry (237) */
  ...
  /** @name PalletAssetAssetTransferEntry (239) */
  ...
  /** @name PalletWitnessCall (241) */
  interface PalletWitnessCall extends Enum {
    readonly isCreate: boolean;
    readonly asCreate: {
      readonly identifier: Bytes;
      readonly digest: H256;
      readonly witnessCount: u32;
      readonly authorization: Bytes;
    } & Struct;
    readonly isWitness: boolean;
    readonly asWitness: {
    ...
    readonly type: 'Create' | 'Witness';
  }

  /** @name PalletSudoCall (242) */
  ...
  /** @name CordRuntimeOriginCaller (243) */
  ...
  /** @name PalletDidOriginDidRawOrigin (247) */
  ...
  /** @name SpConsensusBabeDigestsPreDigest (256) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (257) */
  ...
  /** @name SpCoreSr25519VrfVrfSignature (258) */
  interface SpCoreSr25519VrfVrfSignature extends Struct {
    readonly preOutput: U8aFixed;
    readonly proof: U8aFixed;
  }

  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (259) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (260) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (261) */
  interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeError (265) */
  ...
  /** @name CordAuthorityMembershipError (266) */
  ...
  /** @name PalletBalancesBalanceLock (270) */
  ...
  /** @name PalletBalancesReasons (271) */
  ...
  /** @name PalletBalancesReserveData (274) */
  interface PalletBalancesReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name PalletBalancesIdAmountRuntimeHoldReason (277) */
  interface PalletBalancesIdAmountRuntimeHoldReason extends Struct {
    readonly id: CordRuntimeRuntimeHoldReason;
    readonly amount: u128;
  }

  /** @name CordRuntimeRuntimeHoldReason (278) */
  ...
  /** @name PalletCollectiveVotes (293) */
  ...
  /** @name PalletCollectiveError (294) */
  ...
  /** @name PalletMembershipError (296) */
  ...
  /** @name SpStakingOffenceOffenceDetails (310) */
  ...
  /** @name PalletIdentityAuthorityProperties (324) */
  ...
  /** @name FrameSupportPreimagesBounded (331) */
  ...
  /** @name SpRuntimeBlakeTwo256 (332) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name PalletSchedulerRetryConfig (334) */
  ...
  /** @name PalletPreimageOldRequestStatus (336) */
  ...
  /** @name PalletPreimageRequestStatus (339) */
  ...
  /** @name PalletMultisigMultisig (346) */
  ...
  /** @name PalletNodeAuthorizationNodeInfo (351) */
  interface PalletNodeAuthorizationNodeInfo extends Struct {
    readonly id: Bytes;
    readonly owner: AccountId32;
  }

  /** @name PalletNodeAuthorizationError (353) */
  ...
  /** @name CordIdentifierIdentifierTypeOf (355) */
  interface CordIdentifierIdentifierTypeOf extends Enum {
    ...
    readonly isWitness: boolean;
    readonly type: 'Asset' | 'Auth' | 'ChainSpace' | 'Did' | 'Rating' | 'Registry' | 'Statement' | 'Schema' | 'Template' | 'Witness';
  }

  /** @name CordIdentifierEventEntry (357) */
  ...
  /** @name CordIdentifierCallTypeOf (358) */
  ...
  /** @name CordIdentifierTimepoint (359) */
  interface CordIdentifierTimepoint extends Struct {
    readonly height: u32;
    readonly index: u32;
  }

  /** @name CordIdentifierError (361) */
  ...
  /** @name PalletNetworkMembershipMemberData (362) */
  interface PalletNetworkMembershipMemberData extends Struct {
    readonly expireOn: u32;
  }

  /** @name PalletNetworkMembershipError (364) */
  ...
  /** @name PalletSchemaSchemaEntry (377) */
  ...
  /** @name PalletChainSpaceSpaceDetails (379) */
  ...
  /** @name PalletChainSpaceSpaceAuthorization (380) */
  ...
  /** @name PalletChainSpacePermissions (381) */
  interface PalletChainSpacePermissions extends Struct {
    readonly bits: u32;
  }

  /** @name PalletChainSpaceError (383) */
  ...
  /** @name PalletStatementStatementDetails (384) */
  ...
  /** @name PalletStatementStatementPresentationDetails (386) */
  ...
  /** @name PalletNetworkScoreRatingEntry (392) */
  ...
  /** @name PalletNetworkScoreEntryTypeOf (393) */
  ...
  /** @name PalletNetworkScoreAggregatedEntryOf (395) */
  interface PalletNetworkScoreAggregatedEntryOf extends Struct {
    readonly countOfTxn: u64;
    readonly totalEncodedRating: u64;
  }

  /** @name PalletNetworkScoreError (397) */
  ...
  /** @name PalletAssetAssetEntry (398) */
  ...
  /** @name PalletAssetVcAssetEntry (399) */
  ...
  /** @name PalletAssetAssetDistributionEntry (403) */
  ...
  /** @name PalletAssetVcAssetDistributionEntry (404) */
  ...
  interface PalletAssetError extends Enum {
    ...
    readonly isInvalidAssetStatus: boolean;
  ...
  /** @name PalletWitnessWitnessEntry (407) */
  interface PalletWitnessWitnessEntry extends Struct {
    readonly witnessCreator: AccountId32;
    readonly digest: H256;
    readonly requiredWitnessCount: u32;
    readonly currentWitnessCount: u32;
    readonly witnessStatus: PalletWitnessWitnessStatusOf;
    readonly createdAt: u32;
  }

  /** @name PalletWitnessWitnessSignersEntry (408) */
  interface PalletWitnessWitnessSignersEntry extends Struct {
    readonly witnesses: Vec<AccountId32>;
    readonly createdAt: u32;
  }

  /** @name PalletWitnessError (410) */
  interface PalletWitnessError extends Enum {
    readonly isInvalidIdentifierLength: boolean;
    readonly isUnauthorizedOperation: boolean;
    readonly isDocumentIdNotFound: boolean;
    readonly isInvalidWitnessCount: boolean;
    readonly isMaxWitnessCountReached: boolean;
    readonly isDocumentIdAlreadyExists: boolean;
    readonly isDocumentIdAlreadyApproved: boolean;
    readonly isWitnessSignerCannotBeSameAsWitnessCreator: boolean;
    readonly isSignerIsAlreadyAWitness: boolean;
    readonly isDocumentDigestHasChanged: boolean;
    readonly type: 'InvalidIdentifierLength' | 'UnauthorizedOperation' | 'DocumentIdNotFound' | 'InvalidWitnessCount' | 'MaxWitnessCountReached' | 'DocumentIdAlreadyExists' | 'DocumentIdAlreadyApproved' | 'WitnessSignerCannotBeSameAsWitnessCreator' | 'SignerIsAlreadyAWitness' | 'DocumentDigestHasChanged';
  }
  ...
  /** @name PalletNetworkMembershipCheckNetworkMembership (414) */
  type PalletNetworkMembershipCheckNetworkMembership = Null;

  /** @name FrameSystemExtensionsCheckNonZeroSender (415) */
