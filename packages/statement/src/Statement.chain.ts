 ...
 * @param creatorAddress - The account of the creator of the statement.
 ...
 * @param creatorAddress - The account address creator of the statement. This identifier is
 ...
 *
 * @param {string} creatorAddress - The `creatorAddress` parameter is a string that represents the address
 * of the creator of the statement. It is used to authorize the transaction that registers the statement.
 *
 ...
 *        creator URI, space URI, and optionally a schema URI.
 * @param creatorAddress - The account address creator of the statement. 
 * @param authorAccount - The blockchain account used to sign and submit the transaction.
 * @param authorizationUri - The URI of the authorization used for the statement.
 ...
 *
 * @param {string} creatorAddress - The `creatorAddress` parameter in the `dispatchRevokeToChain` function
 * is a string that represents the address of the creator of the statement. 
 *
...
export async function prepareExtrinsicToRevoke(
  ...
  try {
    ...
    const extrinsic = api.tx.statement.revoke(stmtId, authorizationId)
 ...
 * digest, space URI, creator account address, schema URI (if applicable), and revocation status.
 *
...
export async function fetchStatementDetailsfromChain(
  ...
  const elementCreator = elementChainCreator.toString()
  ...
  const statementStatus: IStatementStatusAccountType = {
