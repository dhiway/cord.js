...
// import { Credential } from '@cord.network/modules'
...
// const spy = jest
//   .spyOn(Credential, 'query')
//   .mockImplementation(async (): Promise<Credential | null> => credential)
...
//   describe('attested', () => {
//     beforeAll(() => {
//       spy.mockImplementation(async (): Promise<Credential> => credential)
//     })

//     it('verifies Cord Credential Proof', async () => {
//       await expect(
...
//   describe('revoked', () => {
//     beforeAll(() => {
//       const revoked = { ...credential, revoked: true }
//       spy.mockImplementation(
//         async (): Promise<Credential> => revoked as Credential
//       )
//     })

//     it('fails to verify Cord Credential Proof', async () => {
//       await expect(
//         jsigs.verify(credential, { suite, purpose, documentLoader })
...
//     beforeAll(() => {
//       spy.mockImplementation(async (): Promise<Credential | null> => null)
//     })
