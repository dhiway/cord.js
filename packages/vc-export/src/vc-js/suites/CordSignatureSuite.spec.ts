...
import Suite from './CordSignatureSuite'
...
import { CORD_SELF_SIGNED_PROOF_TYPE } from '../../constants'
...
beforeAll(async () => {
  ...
  credential.proof.some((p) => {
    if (p.type === CORD_SELF_SIGNED_PROOF_TYPE) {
...
describe('jsigs', () => {
  ...
  describe('verification', () => {
    ...
    it('verifies Cord Self Signed Proof', async () => {
      await expect(
