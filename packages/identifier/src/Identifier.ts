...
const IDENT_TO_PREFIX_MAP = new Map([
  ...
  [REGISTRIES_IDENT, REGISTRY_PREFIX],
  [REGISTRYAUTH_IDENT, REGISTRYAUTH_PREFIX],
  [ENTRIES_IDENT, ENTRIES_PREFIX],
  [SCHEMA_IDENT, SCHEMA_PREFIX],
  [NAMESPACE_IDENT, NAMESPACE_PREFIX],
  [NAMESPACEAUTH_IDENT, NAMESPACEAUTH_PREFIX],
])
