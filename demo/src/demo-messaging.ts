...
async function main() {
  ...
  // console.log("Line 285,verifierKeys.authentication.address ",verifierKeys.authentication.address)
  console.log(
  ...
  let requestBodyContent = {schemas:{...requestCredentialContent},challenge:msgChallenge}
  const messageBodyForHolder: Cord.IRequestCredential = {
      type: 'request-credential-document',
      content:{requestBodyContent},
    }
  const messageForHolder = Cord.Message.fromBody(messageBodyForHolder,verifierDid.uri,holderDid.uri)
